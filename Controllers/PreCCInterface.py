...
sys.path.append("..")
from Upgrades import prequestionasking
...
def CCInterface(uid, laststage):
    with concurrent.futures.ThreadPoolExecutor() as executor:
        ...
        chatter_interface_future = executor.submit(prequestionasking.form_interface, uid)
        ...
        # Return the response
        return {"prechitchat": chatter_interface_result}
