...
sys.path.append("..") 
from Components import chitchatter
...
def CCInterface():
    dbops.upconversation_b(uid, 'Hi, how are you?')
...
def CCInterface():
    with concurrent.futures.ThreadPoolExecutor() as executor:
        ...
        executor.submit(slotFiller.profile_editor)
        
        # Submit the second function for execution
        chatter_interface_future = executor.submit(chitchatter.chatter_interface)
