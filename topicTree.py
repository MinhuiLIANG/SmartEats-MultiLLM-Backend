...
cc = {'name':'chitchat','child1':'preference','child2':'none','parent':'icebreak'}
pre = {'name':'preference','child1':'rec1','child2':'none','parent':'chitchat'}
r1 = {'name':'rec1','child1':'end1','child2':'feedback','parent':'preference'}
...
constraits = [('icebreak','down'),('chitchat','down'),('chitchat','keep'),('preference','down'),('rec1','left'),('rec1','right'),('feedback','down'),('rec2','down')]
